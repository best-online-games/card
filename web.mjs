...
;
	...
	($.$bog_card_icon_arrow) = class $bog_card_icon_arrow extends ($.$mol_icon) {
		path(){
...
;
	($.$bog_card) = class $bog_card extends ($.$mol_page) {
		...
		title(){
			return (this.$.$mol_locale.text("$bog_card_title"));
		}
		plugins(){
			return [(this.Theme())];
		}
	...
	($mol_mem(($.$bog_card.prototype), "Service_tag3"));
	($mol_mem(($.$bog_card.prototype), "Service_tag4"));
	($mol_mem(($.$bog_card.prototype), "Service_tag5"));
